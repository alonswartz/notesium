...
@test "list: sort by mtime" {
    ...
    [ "${lines[1]}" == "26f89821.md:1: lorem ipsum" ]
    [ "${lines[2]}" == "b0457228.md:1: albert einstein" ]
    [ "${lines[3]}" == "406c52f1.md:1: richard feynman" ]
    [ "${lines[4]}" == "5c13e273.md:1: surely you're joking mr. feynman" ]
    [ "${lines[5]}" == "ce5f6bd5.md:1: quantum mechanics" ]
...
@test "list: prefix label and sort by mtime" {
    ...
    [ "${lines[1]}" == "406c52f1.md:1: physicist richard feynman" ]
    [ "${lines[2]}" == "5c13e273.md:1: book surely you're joking mr. feynman" ]
...
@test "list: prefix mtime" {
    ...
    echo "$output"
    [ "${lines[0]}" == "0c8bea98.md:1: 2023-03-27 book" ]
    [ "${lines[1]}" == "26f89821.md:1: 2023-03-27 lorem ipsum" ]
    [ "${lines[2]}" == "3ec9906f.md:1: 2023-03-27 empty note" ]
    [ "${lines[3]}" == "406c52f1.md:1: 2023-03-27 richard feynman" ]
    [ "${lines[4]}" == "572878f1.md:1: 2023-03-27 physicist" ]
    [ "${lines[5]}" == "5c13e273.md:1: 2023-03-27 surely you're joking mr. feynman" ]
    [ "${lines[6]}" == "b0457228.md:1: 2023-03-27 albert einstein" ]
    [ "${lines[7]}" == "ce5f6bd5.md:1: 2023-03-27 quantum mechanics" ]
}

@test "list: prefix mtime and sort by title" {
    run notesium.sh list --prefix=mtime --sort=title
    echo "$output"
    [ "${lines[0]}" == "b0457228.md:1: 2023-03-27 albert einstein" ]
    [ "${lines[1]}" == "0c8bea98.md:1: 2023-03-27 book" ]
    [ "${lines[2]}" == "3ec9906f.md:1: 2023-03-27 empty note" ]
    [ "${lines[3]}" == "26f89821.md:1: 2023-03-27 lorem ipsum" ]
    [ "${lines[4]}" == "572878f1.md:1: 2023-03-27 physicist" ]
    [ "${lines[5]}" == "ce5f6bd5.md:1: 2023-03-27 quantum mechanics" ]
    [ "${lines[6]}" == "406c52f1.md:1: 2023-03-27 richard feynman" ]
    [ "${lines[7]}" == "5c13e273.md:1: 2023-03-27 surely you're joking mr. feynman" ]
}

@test "list: prefix mtime and sort by mtime" {
    run notesium.sh list --prefix=mtime --sort=mtime
    echo "$output"
    [ "${lines[0]}" == "3ec9906f.md:1: 2023-03-27 empty note" ]
    [ "${lines[1]}" == "26f89821.md:1: 2023-03-27 lorem ipsum" ]
    [ "${lines[2]}" == "b0457228.md:1: 2023-03-27 albert einstein" ]
    [ "${lines[3]}" == "406c52f1.md:1: 2023-03-27 richard feynman" ]
    [ "${lines[4]}" == "5c13e273.md:1: 2023-03-27 surely you're joking mr. feynman" ]
    [ "${lines[5]}" == "ce5f6bd5.md:1: 2023-03-27 quantum mechanics" ]
    [ "${lines[6]}" == "572878f1.md:1: 2023-03-27 physicist" ]
    [ "${lines[7]}" == "0c8bea98.md:1: 2023-03-27 book" ]
}
...
@test "list: match and sort by mtime" {
    ...
    echo "$output"
    [ "${lines[0]}" == "b0457228.md:7: albert einstein" ]
    [ "${lines[1]}" == "406c52f1.md:5: richard feynman" ]
    [ "${lines[2]}" == "ce5f6bd5.md:1: quantum mechanics" ]
}
